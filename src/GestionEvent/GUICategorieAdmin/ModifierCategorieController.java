...
//import static GestionEvent.GUIAccueilCoach.AfficherEventCoachController.getIt;
...
public class ModifierCategorieController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        String Db_picture = sc.get_Db_picture(sc.get_ID(getIt()));
        File pic = new File(Db_picture);
        //URL urll = new URL("http://" + Db_picture);
        //BufferedImage image;
        //image = javax.imageio.ImageIO.read(urll);
    ...
    public void Modifier_cate(ActionEvent event) throws IOException {
        ...
        Service_Event ev = new Service_Event();
        System.out.println(ev.pic_Exist(bpath));
        ...
        AfficherCategorieController ac = new AfficherCategorieController();
        ac.seeMe(ac.L);
