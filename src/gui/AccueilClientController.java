...
public class AccueilClientController implements Initializable {
    ...
    public static String clientoucoach="x";

    public static String getClientoucoach() {
    ...
    @FXML
    private void athlestime(MouseEvent event) throws IOException {
    ...
    @FXML
    private void dirigerMessagerieEtAmies(MouseEvent event) throws IOException {
        border.setVisible(true);
        Color c = Color.web("0xEEEEEE",1.0);
        border.setBackground(new Background(new BackgroundFill(c, null, null)));
