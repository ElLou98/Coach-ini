...
import GestionReview.services.SeanceCrud;
 ...
 * @author Adem
 */
public class MainPlaningCoach extends Application { // planing Coach
...
//              } catch (SQLException ex) {System.err.println(ex.getMessage());}
        String to = "donia.kacem@esprit.tn";//take user email address from database  ( get emailClient ) 
        final String user = "coachiniapp@gmail.com";//save it like this   
        final String password = "coach2021";//pass of user  
    ...
    private void printAppointment(Agenda.Appointment a) {
        ...
        SeanceCrud rc = new SeanceCrud();
        rc.AjouterSeance(new Seance(clienttf.getText(),
                a.getSummary(),
                a.getDescription(),
                a.getEndLocalDateTime().format(DateTimeFormatter.ISO_DATE),
                a.getStartLocalDateTime().format(DateTimeFormatter.ISO_TIME),
                a.getEndLocalDateTime().format(DateTimeFormatter.ISO_TIME),
                a.getLocation()) 
        ); 
