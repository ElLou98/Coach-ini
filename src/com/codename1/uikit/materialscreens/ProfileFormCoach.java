 ...
 * @author masso
 */
public class ProfileFormCoach extends SideMenuBaseForm {
    public ProfileFormCoach(Resources res) {
        super(BoxLayout.y());
        ...
        Container titleCmp = BoxLayout.encloseY(
                        ...
                        BorderLayout.centerAbsolute(
                                BoxLayout.encloseY(
                                    new Label(EncapsulationCompte.getNomDutilisateur(), "Title"),
