 ...
 * @author masso
 */
public class SinscrireCoachController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        in_profession.setPromptText("Profession");
    ...
    private void ajouterCompte(ActionEvent event) {
        if(in_verifCode.getText().equals("457812963"))
        {
            ...
            Coach c = new Coach(in_userName.getText(), in_nom.getText(), in_prenom.getText(), Integer.parseInt(in_age.getText()), in_email.getText(), CompteCRUD.encrypt(in_password.getText()), Integer.parseInt(in_numTel.getText()),in_profession.getText());
            cc.ajouterCoach(c);
            JOptionPane.showMessageDialog(null, "Compte ajouté!");
            Compte com=CompteCRUD.rechercherCompte(in_userName.getText());
            EncapsulationComtpe encapsulationCompte= new EncapsulationComtpe(com.getId(), in_userName.getText(), c.getNom(), c.getPrenom(), c.getAge(), c.getAdresseMail(), c.getMotDePasse(),c.getNumTel(),c.getProfession());
